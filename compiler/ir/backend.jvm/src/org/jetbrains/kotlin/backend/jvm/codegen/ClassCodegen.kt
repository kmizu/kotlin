...
open class ClassCodegen protected constructor(
    ...
    fun createClassCodegenForLambdaBody(lambda: IrFunction): ClassCodegen =
        object : ClassCodegen(lambda.parentAsClass, context, parentFunction = parentFunction, withinInline = withinInline) {
